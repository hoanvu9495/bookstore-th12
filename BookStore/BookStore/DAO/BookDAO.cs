...
namespace BookStore.DAO
{
    public class BookDAO
    {
        ...
        public IQueryable<BSSACH> listBook()
        {
            var ret = (from s in db.BSSACHes
                       select s);
            return ret;
        }
        ...
        public static BookCode chiTietSach(int MaSach)
        {
            ...
            BC.KhuyenMai = (data.BSKHUYENMAIs.SingleOrDefault(n => n.MASACH == sach.MASACH) == null) ? 0 : data.BSKHUYENMAIs.SingleOrDefault(n => n.MASACH == sach.MASACH).KM;
